      ...
      <Column className="bg-gray_50 font-inter items-center justify-start mx-[auto] lg:pb-[171px] xl:pb-[214px] 2xl:pb-[241px] 3xl:pb-[289px] w-[100%]">
        <Column className="items-center justify-start w-[100%]">
          ...
          <Column className="items-center justify-start lg:mt-[17px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] w-[48%]">
            <Column className="bg-white_A700 border border-bluegray_50 border-solid items-center justify-start xl:p-[10px] 2xl:p-[12px] 3xl:p-[14px] lg:p-[8px] rounded-radius8 w-[100%]">
            ...
            <Row className="items-center justify-between lg:mt-[17px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] w-[100%]">
              <Column className="bg-white_A700 border border-bluegray_50 border-solid lg:p-[10px] xl:p-[13px] 2xl:p-[15px] 3xl:p-[18px] rounded-radius8 w-[48%]">
              ...
              <Column className="bg-white_A700 border border-bluegray_50 border-solid items-center lg:p-[12px] xl:p-[16px] 2xl:p-[18px] 3xl:p-[21px] rounded-radius8 w-[48%]">
                <Row className="items-start justify-between w-[100%]">
                  <Text className="rownewposts" as="h3" variant="h3">
                    Stale posts
                  </Text>
