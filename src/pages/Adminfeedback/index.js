              ...
              <Stack className="lg:h-[341px] xl:h-[426px] 2xl:h-[479px] 3xl:h-[575px] xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[8px] w-[100%]">
                ...
                <Column className="absolute justify-start pt-[3px] right-[1%] top-[3%] w-[37%]">
                  <Column className="justify-start w-[96%]">
                    ...
                    <Row className="items-start lg:mt-[5px] xl:mt-[6px] 2xl:mt-[7px] 3xl:mt-[9px] pt-[1px] w-[34%]">
                      <Text className="rowboard" variant="body1">
                        Owner
                      </Text>
                      <Row className="items-start justify-evenly mb-[1px] lg:ml-[16px] xl:ml-[20px] 2xl:ml-[23px] 3xl:ml-[27px] w-[41%]">
                        <Text
                          className="bg-purple_200 flex items-center mb-[1px] lg:px-[2px] 2xl:px-[3px] xl:px-[3px] 3xl:px-[4px] rounded-radius50 text-white_A700 w-[16px]"
                          as="h1"
                          variant="h1"
                        >
                          K
